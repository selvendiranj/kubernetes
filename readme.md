...
This guide will help you to setup kubernetes cluster by creating hyperv vm on hosted azure vm. I chose Container Linux as the base image for the kubernetes cluster operating system. Refer these steps one by one and setup the cluster. If you have difficulties setting the cluster, please raise issue in this github repo, I will address as quick as possible.
